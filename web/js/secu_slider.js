function onImgSlider(value) {
    if (value == 100)   {
        document.getElementById('img_secu_text').innerHTML = 'A logo, your name and the name of the viewer will be applied heavily across the image (Will severely distort image)';
    }
    else if (value == 75)   {
        document.getElementById('img_secu_text').innerHTML = 'A small logo, your name and the name of the viewer will be applied';
    }
    else if (value == 50)   {
        document.getElementById('img_secu_text').innerHTML = 'A small logo and your name will be applied';
    }
    else if (value == 25)   {
        document.getElementById('img_secu_text').innerHTML = 'A small logo will be applied';
    }
    else {
